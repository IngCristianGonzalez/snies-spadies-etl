# Tasks: 002 — Lectura de dimensión tiempo

- [ ] T1 — Definir la excepción y el contrato de entrada/salida del lector en
  `etl/extract_dimensions.py`. Cubre: R1, R3, R4, R5, R13.
- [ ] T2 — Implementar la apertura del libro y el escaneo de hojas y filas de
  encabezado. Cubre: R1, R2, R4, R5.
- [ ] T3 — Implementar la selección exclusiva de `anio` y `semestre` y la
  conversión de enteros válidos. Cubre: R6, R7, R13.
- [ ] T4 — Implementar la validación de año positivo y semestre 1/2 con
  clasificación de filas omitidas. Cubre: R8, R9, R10, R11.
- [ ] T5 — Implementar la deduplicación estable por `(anio, semestre)` y el
  reporte de duplicados. Cubre: R12, R13.
- [ ] T6 — Implementar logging estructurado para filas omitidas y resultado
