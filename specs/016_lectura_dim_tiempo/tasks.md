...
- [x] T7 — Integrar el lector en `main_dimensiones.py` sin añadir carga a
  PostgreSQL. Cubre: R1, R6, R13.
- [x] T8 — Testear archivo inexistente con error descriptivo. Cubre: R1, R3.
- [x] T9 — Testear detección de encabezado después de filas introductorias y
  columnas adicionales. Cubre: R2, R6.
- [x] T10 — Testear ausencia de columnas y múltiples hojas candidatas. Cubre:
  R4, R5.
- [x] T11 — Testear conversión de enteros y rechazo de valores no enteros,
  años no positivos y semestres inválidos. Cubre: R7, R8, R9, R10.
- [x] T12 — Testear omisión de filas vacías y verificar sus eventos de logging.
  Cubre: R11, R15.
- [x] T13 — Testear conservación de la primera ocurrencia y logging de
  duplicados. Cubre: R12, R15.
- [x] T14 — Testear `DataFrame` vacío y evento de error cuando no quedan filas
  válidas. Cubre: R13, R14.
- [x] T15 — Ejecutar compileall, Ruff, mypy y pytest aplicables y documentar
